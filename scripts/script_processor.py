...
parser.add_argument('--image_uri', dest='image_uri',
                    help='URI of docker image', default='204031725010.dkr.ecr.us-east-2.amazonaws.com/bld-alphapose:v3')
...
script_processor.run(
    ...
    arguments=[
        "--cfg", "/workspace/alphapose/configs/coco/resnet/256x192_res50_lr1e-3_1x.yaml", 
